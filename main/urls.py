...
from main.views import show_main, create_product, delete_item, show_xml, show_json, show_xml_by_id, show_json_by_id, reduce_amount, increase_amount, get_product_json, add_product_ajax, increase_amount_ajax, get_updated_data, delete_item_ajax, create_product_flutter
